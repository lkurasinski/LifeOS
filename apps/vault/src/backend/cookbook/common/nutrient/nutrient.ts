...
export const NUTRIENTS: Record<
	string,
	{ code: string; name_pl: string; name_en: string; unit: Unit; category: string }
> = {
	ENERA_kcal: {
		code: 'ENERA_kcal',
	...
	ID_mcg: { code: 'ID_mcg', name_pl: 'Jod', name_en: 'Iodine', unit: 'mcg', category: 'mineral' },
	MO_mcg: {
		code: 'MO_mcg',
		name_pl: 'Molibden',
		name_en: 'Molybdenum',
	...
	B_mcg: { code: 'B_mcg', name_pl: 'Bor', name_en: 'Boron', unit: 'mcg', category: 'mineral' },
	NI_mcg: {
		code: 'NI_mcg',
		name_pl: 'Nikiel',
		name_en: 'Nickel',
